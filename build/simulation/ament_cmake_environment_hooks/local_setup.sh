...
: ${AMENT_CURRENT_PREFIX:="/home/beraa/ros2_ws/src/simulation/install/simulation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/simulation/environment/pythonpath.sh"
